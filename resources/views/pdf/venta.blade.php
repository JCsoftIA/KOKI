...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/logo2.png" alt="Macrotiendas KOKY" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>Macrotiendas KOKY</b><br>Av Real Nro ###, Huancayo - Junin - Perú<br>Telefono:(+51)931760744<br>Email:ajcarlos032@gmail.com
                </p>
            </div>
            <div id="fact">

                                ...
                                <div class="modal-body">
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" v-model="descripcion" name="descripcion" class="form-control" placeholder="Descripcion de categoria">
                                            </div>
                                            <div v-show="errorCategoria" class="form-group row div-error">
                                                <div class="text-center text-error">
                                                    <div class="text-center pt-3" v-for="error in errorMostrarMsjCategoria" :key="error" v-text="error">

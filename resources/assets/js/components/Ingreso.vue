                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        <tr v-for="ingreso in arrayIngreso" :key="ingreso.id">
                                            ...
                                            <td v-text="ingreso.num_documento"></td>
                                            <td v-text="ingreso.direccion"></td>
                                            <td v-text="ingreso.telefono"></td>
                                            <td v-text="ingreso.email"></td>
                                            <td v-text="ingreso.usuario"></td>
                                            <td v-text="ingreso.rol"></td>
                                        </tr>                                
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-inline">
                                            <input type="text" class="form-control" v-model="codigo" @keyup.enter="buscarProducto()" placeholder="Ingrese codigo Producto">
                                ...
                                <div class="table-responsive col-md-12">
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="background-color: #00101C !important;" >
                                                <td class="rounded" colspan="4" align="right"><strong>Total Parcial</strong></td>
                                                <td class="rounded">$5</td>
                                            </tr>
                                            <tr style="background-color: #00101C !important;" >
                                                <td class="rounded" colspan="4" align="right"><strong>Total Impuesto</strong></td>
                                                <td class="rounded">$5</td>
                                            </tr>
                                            <tr style="background-color: #00101C !important;" >
                                                <td class="rounded" colspan="4" align="right"><strong>Total Neto</strong></td>
                                                <td class="rounded">$5</td>
                                            </tr>
                                        </tbody>
                                    </table>
